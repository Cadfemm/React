// Point 3: now uses useAssessmentForm hook
// Point 4: uses shared ScorePill
import { useCallback, useMemo, memo } from "react";
import CommonFormBuilder from "../CommonComponenets/FormBuilder";
import { useAssessmentForm } from "../../shared/form/hooks/useAssessmentForm";
  ...
  sections: [
    {
      ...
      fields: [{ type: "scale-table", name: "vf_tasks", columns: DIFFICULTY_OPTIONS, rows: [
    ...
    },
    {
      title: "Driving",
      fields: [
        { type: "radio", name: "drive_now", label: "Do you currently drive a car?", options: [{ label: "Yes", value: "Yes" }, { label: "No", value: "No" }] },
        { type: "single-select", name: "drive_day",       label: "How much difficulty do you have driving during the day because of your vision?",  showIf: { field: "drive_now", equals: "Yes" }, options: [{ label: "None", value: 4 }, { label: "A little", value: 3 }, { label: "Moderate amount", value: 2 }, { label: "A great deal", value: 1 }] },
        { type: "single-select", name: "drive_night",     label: "How much difficulty do you have driving at night because of your vision?",         showIf: { field: "drive_now", equals: "Yes" }, options: [{ label: "None", value: 4 }, { label: "A little", value: 3 }, { label: "Moderate amount", value: 2 }, { label: "A great deal", value: 1 }] },
        { type: "radio",         name: "drive_stopped",   label: "Have you previously driven a car but since stopped?", options: [{ label: "Yes", value: "Yes" }, { label: "No", value: "No" }] },
        { type: "single-select", name: "drive_stop_when", label: "When did you stop driving?",  showIf: { field: "drive_stopped", equals: "Yes" }, options: [{ label: "Less than 6 months ago", value: "lt6" }, { label: "6 to 12 months ago", value: "6to12" }, { label: "More than 12 months ago", value: "gt12" }] },
...
const VisualFunctionForm = memo(function VisualFunctionForm({ onBack, layout = "root" }) {
  // Point 3: uses shared hook
  const { values, submitted, onChange } = useAssessmentForm({ onBack });
...
const scoreRow = { display: "flex", gap: 12, margin: "24px 0", flexWrap: "wrap" };
