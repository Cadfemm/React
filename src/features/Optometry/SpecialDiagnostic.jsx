      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "oct_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "oct_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "vep_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 }, accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "vep_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "hess_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 }, accept: "application/pdf,image/*",
                multiple: false,
              ...
              {
                type: "attach-file", name: "hess_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "revs_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "revs_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "topo_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "topo_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "dem_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "dem_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "ap_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "ap_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "micro_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "micro_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "np_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "np_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
...

      {
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              {
                type: "attach-file", name: "cv_re_file", label: "Right Eye (RE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              },
              {
                type: "attach-file", name: "cv_le_file", label: "Left Eye (LE)", accept: "application/pdf,image/*",
                multiple: false,
                hideInputAfterSelect: true,
                previewSize: { width: 400, height: 400 },
              }
