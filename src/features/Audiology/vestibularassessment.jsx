...
export function VestibularAdvancedForm({ onBack, mode }) {
  ...
  const computeVHQ = (v) => {
    let total = 0;
    for (let i = 1; i <= 25; i++) total += Number(v[`vhq_${i}`] || 0);
    return { total };
  };

  const computeMVVSS = (v) => {
    let total = 0;
    for (let i = 1; i <= 14; i++) total += Number(v[`mvvss_${i}`] || 0);
    return { total };
  };
  ...
  const schema = {
    ...
    // ======================
    {
      ...
      fields: [
        {
          ...
          cols: 2,
          fields: [
            { name: "nystagmus_other_test",       label: "Test",       type: "input" },
            { name: "nystagmus_other_impression", label: "Impression", type: "input" }
          ]
        }]
      },
...

      {
        ...
        fields: [{
          ...
          children: [{
            ...
            showColumnHeaders: true,
            showGroupHeaders: false,
            groups: [{ label: null, columns: [{ key: "Result" }, { key: "Impression" }] }],
            rows: [
              { value: "clockwise",     label: "Clockwise",     columns: [{ type: "input" }, { type: "input" }] },
              { value: "anticlockwise", label: "Anticlockwise", columns: [{ type: "input" }, { type: "input" }] },
              { value: "blank",         label: "Blank",         columns: [{ type: "input" }, { type: "input" }] }
            ]
          }]
        }]
      },

      {
        ...
        fields: [{
          ...
          children: [{
            ...
            showColumnHeaders: true,
            showGroupHeaders: false,
            groups: [{ label: null, columns: [{ key: "Right Side" }, { key: "Left Side" }] }],
            rows: [
              { value: "dixhallpike", label: "Dix Hallpike",                    columns: [{ type: "input" }, { type: "input" }] },
              { value: "epley",       label: "Epley Maneuver",                  columns: [{ type: "input" }, { type: "input" }] },
              { value: "rolltest",    label: "Roll Test",                       columns: [{ type: "input" }, { type: "input" }] },
              { value: "barbecue",    label: "Barbecue Roll Test",              columns: [{ type: "input" }, { type: "input" }] },
              { value: "supine",      label: "Supine Straight Head Extension",  columns: [{ type: "input" }, { type: "input" }] },
              { value: "semont",      label: "Semont",                          columns: [{ type: "input" }, { type: "input" }] },
              { value: "gufoni",      label: "Gufoni",                          columns: [{ type: "input" }, { type: "input" }] },
              { value: "appiani",     label: "Appiani",                         columns: [{ type: "input" }, { type: "input" }] },
              { value: "others",      label: "Others",                          columns: [{ type: "input" }, { type: "input" }] }
            ]
          }]
        }]
      },
        ...
        fields: [
          {
            ...
            defaultOpen: false,
            children: [...buildBinaryOptions("dva", "")]
          },
          {
            type: "accordion",
            name: "gaze_section",
            ...
            defaultOpen: false,
            children: [...buildBinaryOptionsgaze("gaze_stab", "")]
          }
        ]
      },

      {
        ...
        fields: [{
          ...
          children: [{
            ...
            showColumnHeaders: true,
            showGroupHeaders: false,
            groups: [{ label: null, columns: [{ key: "n" }, { key: "Mean Gain" }, { key: "Standard Deviation" }, { key: "Asymmetry (%)" }, { key: "Impression" }] }],
            rows: [
...

      {
        ...
        fields: [{
          ...
          children: [{
            ...
            showColumnHeaders: true,
            showGroupHeaders: false,
            groups: [{ label: null, columns: [{ key: "N" }, { key: "P1" }, { key: "N1" }, { key: "P1-N1 (%)" }, { key: "Impression" }] }],
            rows: [
              { value: "right", label: "Right Ear", columns: [{type:"input",name:"cvemp_right_n"},{type:"input",name:"cvemp_right_p1"},{type:"input",name:"cvemp_right_n1"},{type:"input",name:"cvemp_right_asym"},{type:"input",name:"cvemp_right_impression"}] },
              { value: "left",  label: "Left Ear",  columns: [{type:"input",name:"cvemp_left_n"}, {type:"input",name:"cvemp_left_p1"}, {type:"input",name:"cvemp_left_n1"}, {type:"input",name:"cvemp_left_asym"}, {type:"input",name:"cvemp_left_impression"}] }
            ]
          }]
        }]
      },

      {
        ...
        fields: [{
          ...
          children: [{
            ...
            showColumnHeaders: true,
            showGroupHeaders: false,
            groups: [{ label: null, columns: [{ key: "N" }, { key: "N1" }, { key: "P1" }, { key: "N1-P1 (%)" }, { key: "Impression" }] }],
            rows: [
              { value: "right", label: "Right Ear", columns: [{type:"input",name:"ovemp_right_n"},{type:"input",name:"ovemp_right_n1"},{type:"input",name:"ovemp_right_p1"},{type:"input",name:"ovemp_right_asym"},{type:"input",name:"ovemp_right_impression"}] },
              { value: "left",  label: "Left Ear",  columns: [{type:"input",name:"ovemp_left_n"}, {type:"input",name:"ovemp_left_n1"}, {type:"input",name:"ovemp_left_p1"}, {type:"input",name:"ovemp_left_asym"}, {type:"input",name:"ovemp_left_impression"}] }
            ]
          }]
        }]
      },

      {
        title: null,
        fields: [
          { type: "subheading", label: "Special Test" },
          { name: "special_test", label: "Details", type: "input" },
          {
            ...
            children: [{
              ...
              cornerLikeGroupHeader: true,
              showColumnHeaders: true,
              groups: [{ label: null, columns: [{ key: "Yes / No" }, { key: "Remarks" }] }],
              rows: [
                { value: "vre",    label: "Vestibular Rehabilitation Exercises", columns: [{ type: "select", name: "vre_option",    options: [{ label: "No", value: 0 }, { label: "Yes", value: 1 }] }, { type: "input", name: "vre_notes" }] },
                { value: "crm",    label: "Canalith Repositioning Maneuver",     columns: [{ type: "select", name: "crm_option",    options: [{ label: "No", value: 0 }, { label: "Yes", value: 1 }] }, { type: "input", name: "crm_notes" }] },
                { value: "gst",    label: "Gaze Stability Training",             columns: [{ type: "select", name: "gst_option",    options: [{ label: "No", value: 0 }, { label: "Yes", value: 1 }] }, { type: "input", name: "gst_notes" }] },
                { value: "fall",   label: "Fall Prevention Education",           columns: [{ type: "select", name: "fall_option",   options: [{ label: "No", value: 0 }, { label: "Yes", value: 1 }] }, { type: "input", name: "fall_notes" }] },
                { value: "psycho", label: "Psychosocial Counseling",             columns: [{ type: "select", name: "psycho_option", options: [{ label: "No", value: 0 }, { label: "Yes", value: 1 }] }, { type: "input", name: "psycho_notes" }] }
              ]
            }]
          }
        ]
