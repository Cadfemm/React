...
const OPTION_CARDS = [
  {
    ...
    description: "Full assessment for a new psychology visit",
    icon: "📋",
    color: "#2563EB"
  },
  {
  ...
  },
  {
    ...
    description: "Track progress and interventions",
    icon: "📈",
    color: "#7C3AED"
  },
  {
    ...
    description: "Group session documentation",
    icon: "👥",
    color: "#EA580C"
  }
];

export default function PsychologyPatients({ Patients, onBack }) {
    ...
    <div style={styles.page}>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Manage and start psychology assessments</p>
        </div>
      ...
      <div style={styles.card}>
        ...
        {patients.length === 0 ? (
          <div style={styles.emptyState}>No patients assigned</div>
        ) : (
          patients.map((p) => (
            <div
              key={p.id}
