    ...
    sections: [
      {
        fields: [
          ...
          { name: "amp_muscle_tone_launcher", label: "", type: "assessment-launcher", options: [{ label: "Modified Ashworth Scale (MAS)", value: "mas_scale" }], showIf: { field: "category", includes: "amputation" } },
          {
            name: "amp_rom_launcher",
            label: "",
            type: "assessment-launcher",
            options: [{ label: "Mobility of Joint Functions: ROM", value: "rom" }],
            showIf: { field: "category", includes: "amputation" },
          },
          { name: "amp_mrc_launcher", label: "", type: "assessment-launcher", options: [{ label: "Muscle Power Functions: MRC Grading", value: "mrc_scale" }], showIf: { field: "category", includes: "amputation" } },
          ...
          { name: "amp_skin_colour", label: "1. Colour", type: "radio", options: [{ label: "Normal", value: "normal" }, { label: "Cyanotic", value: "cyanotic" }, { label: "Erythematous", value: "erythematous" }], showIf: { field: "category", includes: "amputation" } },
          { name: "amp_skin_moisture", label: "2. Moisture", type: "radio", options: [{ label: "Dry", value: "dry" }, { label: "Scaly", value: "scaly" }, { label: "Moist", value: "moist" }], showIf: { field: "category", includes: "amputation" } },
          { name: "amp_skin_integrity", label: "3. Integrity", type: "radio", options: [{ label: "Ulcer", value: "ulcer" }, { label: "Blister", value: "blister" }, { label: "Scar", value: "scar" }, { label: "Infection", value: "infection" }], showIf: { field: "category", includes: "amputation" } },
          { name: "amp_graft_flap_viability", label: "4. Graft / Flap Viability", type: "radio", options: [{ label: "Yes", value: "yes" }, { label: "No graft / flap", value: "no_graft_flap" }], showIf: { field: "category", includes: "amputation" } },
          { name: "amp_edema_swelling", label: "5. Edema / Swelling", type: "radio", options: ["Yes", "No"], showIf: { field: "category", includes: "amputation" } },
          { name: "amp_trophic_changes", label: "6. Trophic Changes", type: "radio", options: ["Yes", "No"], showIf: { field: "category", includes: "amputation" } },
